...
Return calculationOfReturn (Return abnormalReturn, StockMap stocklist,vector<double>spy ){
...
Matrix finalCalculation(Group group1,vector<double>spy, StockMap StockList){
    ...
    Return abnormalReturn;
    abnormalReturn = calculationOfReturn(abnormalReturn, StockList, spy);
    ...
    for (int j = 0; j < 30 ;j++){
        ...
        //abnormalReturn1=calculationOfReturn(abnormalReturn1, StockList, spy);
        //abnormalReturn2=calculationOfReturn(abnormalReturn2, StockList, spy);
        //abnormalReturn3=calculationOfReturn(abnormalReturn3, StockList,spy);
